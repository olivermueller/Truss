...
public class ZoomTestWindow : EditorWindow
{
    ...
    {
        ZoomTestWindow window = EditorWindow.GetWindow(typeof(ZoomTestWindow),false) as ZoomTestWindow;
    ...
    private void DrawZoomArea()
    {
        ...
        GUI.Box(new Rect(0.0f - _zoomCoordsOrigin.x, 0.0f - _zoomCoordsOrigin.y, 500.0f, 300.0f), "Zoomed Box");
